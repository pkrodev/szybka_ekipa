...
export const faqs: FAQ[] = [
  {
    ...
    answer: "W większości przypadków jesteśmy w stanie przyjechać tego samego dnia lub następnego dnia roboczego. Pracujemy 7 dni w tygodniu, w godzinach 6:00-22:00, więc jesteśmy elastyczni i dostosowujemy się do Twoich potrzeb. Skontaktuj się z nami, aby ustalić dokładny termin.",
    category: "ogólne",
  },
  {
  ...
  },
  {
    ...
    answer: "Tak, możesz skorzystać z formularza kontaktowego i otrzymać wstępną wycenę. Najdokładniejszą wycenę jesteśmy w stanie podać po zobaczeniu zakresu prac - czasami można to zrobić na podstawie zdjęć przesłanych przez WhatsApp lub email. Skorzystaj również z naszego kalkulatora online.",
    category: "cennik",
  },
  {
